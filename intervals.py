...
def find_best_interval(xs, ys, k):
    ...
    # The error of no intervals_list, for the first i points
    E[:m + 1, 0] = cy

    # The minimal error of j intervals_list on 0 points - always 0. No update needed.

    # Fill middle
    for i in range(1, m + 1):
        for j in range(1, k + 1):
            # The minimal error of j intervals_list on the first i points:
